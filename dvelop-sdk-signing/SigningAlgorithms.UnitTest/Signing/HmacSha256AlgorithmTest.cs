...
namespace Dvelop.Sdk.SigningAlgorithms.UnitTest.Signing
{
    ...
    public class HmacSha256AlgorithmTest
    {
        ...
        [TestCase("Input","36ecb4f8669133ce744c21982ba4abe2ecd7086e1dc2226ccd6f266f3a5005f8")]
        [TestCase("{\"type\":\"subscribe\",\"tenantId\":\"id\",\"baseUri\":\"https://someone.d-velop.cloud\"}\n", "c2a6fefc93b809eeaf2f069504fe8e02b0f3341b3c5e488e6a402ca45301415c")]
        ...
        {
            Assert.That(HmacSha256Algorithm.Sha256(input), Is.EqualTo(expected));
        }


        [Test]
        [TestCase("","14cec2793d3c3b01e0d5730d79f187141f9a8ce9e9fa1815a73ffb9df6d61bbe")]
        [TestCase("Input","15c8b4a5aedee67aa3eb383f45ed8dde8713a7e2c94e62ad37fc4aaadda8cd3a")]
        [TestCase("fbfcc87ba2b7ae35506a780388bef9eccb25d734e4a90ad75e8da8002d443128", "cc2bfbac52f30ddee41e4475963f8136c60cab678941560538b1281ad2722aac")]
        public void HmacSha256(string input, string expected)
        {
            Assert.That(HmacSha256Algorithm.HmacSha256(Convert.FromBase64String(Key), input), Is.EqualTo(expected));
        }
        ...
        {
            Assert.That(HmacSha256Algorithm.HmacSha256(Convert.FromBase64String(Key), HmacSha256Algorithm.Sha256(input)), Is.EqualTo(expected));
        }
    }
}
